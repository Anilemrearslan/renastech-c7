...
public class Topic2_HashMap {
    public static void main(String[] args) {
        ...
        MyHashMap.put("Name","Eloise");
        MyHashMap.put("Age","34");
        MyHashMap.put("SurName","Elemen");
        MyHashMap.put("Salary","1324276");
        MyHashMap.put("Country","Brazil");
