...
public class Topic5_Vector {
    public static void main(String[] args) {
        ...
        // to change the all veriable name at oince, use Shift + F6, a popup will open
        MyVector.add(8476);
        MyVector.add(2);
        MyVector.add(8476);
        MyVector.add(4);
        ...
        // If someone else tries to set index 2 at the same time, he/she will get exception
        MyVector.set(2,111);
