...
import CustomClassesForHomework.MonkeyClass;
...
monkeyTrouble(false,   true)   →   false
    ...
    public static void main(String[] args) {
        ...
        MonkeyA.IsSmiling = true;
        MonkeyB.IsSmiling = true;

        System.out.println("we are in trouble: "+monkeyTrouble(MonkeyA.IsSmiling, MonkeyB.IsSmiling));
    }
